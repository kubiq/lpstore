...
class /*Nette\Forms\*/SuggestInput extends TextInput
{
    ...
    */
     ...
     * @return SuggestInput
     */
    public static function addSuggestInput(AppForm $form, $name, $label, $suggestLink = NULL, ISuggester $suggester = NULL, $cols = NULL, $maxLength = NULL)
    {
